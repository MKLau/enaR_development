...
=======
  others??}.  This is due in part to the flexibility of the core
representation, its utility in answering relational questions, and its
applicability to ``Big Data'' problems.  <<SOME SUMMARY SENTENCE -
Methods/Stats>>
>>>>>>> 51fc935f23be41fca16723c6daf032efd040a7f3
%The methodology for network representation and subsequent
%analysis has a
...
NEEDS REVISION >> need to add the 2 schools bit here.  We need this
briefly in the intro to set up the problem and to provide context for
...
\end{Sinput}
\begin{Soutput}
[1] 1.0942223 1.9028744 0.5390105 1.5105592
\end{Soutput}
\begin{Sinput}
> fake.model%v%'living'
\end{Sinput}
...
node1  0.00000 5.122089 2.772212 0.000000
node2  0.00000 0.000000 3.789967 0.000000
node3 11.38181 0.000000 1.671576 1.437608
node4  0.00000 2.383753 6.763708 0.000000
\end{Soutput}
\end{Schunk}
