...
\author{Matthew K. Lau\\Harvard Forest\\Harvard University\\ \And
        ...
        University\\ \And Pawandeep Singh \\ISERC \\Visva-Bharati University}
...
\Address{
  ...
  E-mail: \email{pawan.s@live.co.uk}\\
  URL: \url{https://in.linkedin.com/in/pawan20021992}\\
}
...
\end{Sinput}
\begin{Soutput}
[1] 0.9832709 1.7276378 3.9508456 3.3475543
\end{Soutput}
\begin{Sinput}
> fake.model%v%'living'
\end{Sinput}
...
node1 0.000000 0.1295493 3.707570 4.172578
node2 5.615136 6.8026144 0.000000 4.672064
node3 4.915889 1.9412592 2.261347 4.619334
node4 0.000000 8.8831899 2.652546 2.424396
\end{Soutput}
\end{Schunk}
...
\caption{Ratio of Indirect-to-Direct Flow for six ecosystem models
  ...
  of Indirect-to-Direct flow in the 56 trophic models.} \label{fig:idf}
\end{figure}
