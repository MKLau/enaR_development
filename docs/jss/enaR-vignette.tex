...
\Keywords{ecology, ENA, ecosystems,
  species interactions, networks, \proglang{R}}

\Plainkeywords{ecology, ENA, ecosystems, species interactions,
...
analysis for several decades \citep{borrett12_netecol, ulanowicz86,
  fath99_review}.  The network models are comprised of transfers of
...
ecosystem.  The analyses, collectively known as Ecosystem Network
Analysis (ENA), has been used in a variety of ways.  This includes
...
% p3: Two schools
Two major schools of ENA have developed \citep{schareler09comparing}.
...
called \textit{statnet}
\citep{handcock2008statnet}. While \citet{borrett14enar} introduced the
\textit{enaR} package, here we provide a richer documentation of the
software and illustrate its use.
...
\end{Sinput}
\begin{Soutput}
[1] 1.1104475 2.2869905 0.8789911 0.6739347
\end{Soutput}
\begin{Sinput}
> fake.model%v%'living'
\end{Sinput}
...
node1 0.0000000 3.9276172 4.694592 0.000000
node2 0.9741933 0.0000000 0.000000 0.000000
node3 0.0000000 0.2120078 5.794752 3.494227
node4 0.0000000 0.0000000 0.000000 2.478801
\end{Soutput}
\end{Schunk}
