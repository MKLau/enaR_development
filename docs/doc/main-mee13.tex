...
\section*{Abstract}
\begin{itemize}
\item Ecology at its core is a science that studies relationships. As
  technological developments are making the collection of complex,
  ...
  of ecological systems, such as food-webs.
\item Here, we introduce \enaR , a set of \R\ tools that enables
  ...
  structure and dynamics of ecosystem network models.
\item In addition to introducing the primary functionality of the
  ...
  multiple models simultaneously, and connections to other network and
  ecological analysis tools in \R .
\item We have created this package to enable more ecologists to apply
  ecological network analysis and contribute to ENA software
  development.
\end{itemize}
