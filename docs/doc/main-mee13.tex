...
developments.  Presently, the Ulanowicz School algorithms are more limited, including
the ascendency calculations \citep{ulanowicz97} and mixed trophic
impacts analyses \citep{ulanowicz90}; however, we expect the package
capabilities to continue to grow, especially with the assistance of
new users.  This combination of the Patten and Ulanowicz schools of
analyses is rare in extant software.
...
spine \citep{ulanowicz1979trophic}, and network model construction
...
algorithm for constructing plausible ecosystems models.
...
branch of field of Network Ecology, which is rapidly growing in part
